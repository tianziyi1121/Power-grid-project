            ...
            children: [{
              ...
              children:[
                ...
                },
                {
                  path:'concern',
                  name:'concern',
                  component: ()=>import('@/view/supplier/sup/bui/concern.vue'),
                }
              ]
            },
            {
            ...
            children:[
              {
                path:'judicial',
                name:'judicial',
                component: ()=>import('@/view/supplier/sup/society/judicial.vue'),
              },
              {
                path:'run',
                name:'run',
                component: ()=>import('@/view/supplier/sup/society/run.vue'),
              },
              {
                path:'risk',
                name:'risk',
                component: ()=>import('@/view/supplier/sup/society/risk.vue'),
              },
              {
                path:'move',
                name:'move',
                component: ()=>import('@/view/supplier/sup/society/move.vue'),
              },
              {
                path:'fine',
                name:'fine',
                component: ()=>import('@/view/supplier/sup/society/fine.vue'),
              },
              {
                path:'badly',
                name:'badly',
                component: ()=>import('@/view/supplier/sup/society/badly.vue'),
              }
            ]
          },
          {
